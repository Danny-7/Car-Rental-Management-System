...
INSERT INTO `car` (`id`, `id_owner_id`, `type`, `datasheet`, `amount`, `rent`, `image`, `quantity`) VALUES
	(1, 1, 'Mercedes Classe A', '{"category":"Citadine","fuel":"Essence","engine":"Thermique","shift":"Automatique","nb_portes":"5 portes"}', 300, 'disponible', 'mercedesA.png', 10),
	(2, 1, 'Clio 4', '{"category":"Citadine","fuel":"Diesel","engine":"Thermique","shift":"Manuelle","nb_portes":"5 portes"}', 120, 'disponible', 'S7-modele-renault-clio-4.jpeg', 6),
	...
	(6, 3, 'Porsche Cayenne 2018', '{"category":"4x4, SUV, Crossover","fuel":"Essence","engine":"Thermique","shift":"Automatique","nb_portes":"5 portes"}', 700, 'disponible', 'cayennejpg.jpeg', 4),
